...
const disallowed = {
  ...
  'adapter-openai': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-openai')]),
  'adapter-anthropic': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-anthropic')]),
  'adapter-langchain': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-langchain')]),
  'adapter-google-adk': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-google-adk')]),
  'adapter-llamaindex': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-llamaindex')]),
  'adapter-crewai': new Set(['registry', 'cli', 'mcp', 'adapters', ...adapterImplementations.filter((name) => name !== 'adapter-crewai')]),
};
